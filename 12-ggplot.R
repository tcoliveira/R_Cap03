...
#grafico estatitistico é o mapeamento de dados.

#não faz parte dos pcts basicos do R, são construido camadas por camadas.

#geoms = formas gemetricas será utilizada.

#facets = particionar a area dos graficos
